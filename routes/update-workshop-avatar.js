...
exports.post = function(req, res, next) {
    ...
    form.on('file', function(name,file){
        ...
        fs.readFile(file.path, function (err, data) {
            var newPath = path.normalize(__dirname + "/../public/uploads/workshops/" + userfolder);
        ...
        // Путь 320x240
        var preview_image_dir = path.normalize(__dirname + "/../public/uploads/workshops/" + userfolder + '/320');
        var preview_image_path = path.normalize(__dirname + "/../public/uploads/workshops/" + userfolder + '/320/') + token + 'tmb.jpg';
        var preview_image_relpath = "../uploads/workshops/" + userfolder + '/320/' + token + 'tmb.jpg';
        // Путь 640x480
        var product_image_dir = path.normalize(__dirname + "/../public/uploads/workshops/" + userfolder);
        var product_image_path = path.normalize(__dirname + "/../public/uploads/workshops/" + userfolder + '/') + token  + '.jpg';
        var product_image_relpath = "../uploads/workshops/" + userfolder + '/' + token + '.jpg';
        // Путь 40x40
        var preview_image_dir_mini = path.normalize(__dirname + "/../public/uploads/workshops/" + userfolder + '/40');
        var preview_image_path_mini = path.normalize(__dirname + "/../public/uploads/workshops/" + userfolder + '/40/') + token  + '.jpg';
        var preview_image_relpath_mini = "../uploads/workshops/" + userfolder + '/40/' + token + '.jpg';
    ...
    form.parse(req, function(err, fields, files) {
        ...
        if (formdata['img320']) {
            ...
            var update = { img320: formdata['img320'],
